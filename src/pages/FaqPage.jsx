...
const CATEGORIES = [
  {
    ...
    items: [
      { q: "مورنا کد چیست و برای چه کسانی مناسب است؟", a: "مورنا کد یک پلتفرم آموزش و اشتراک‌گذاری کد است که امکان یادگیری، تمرین و انتشار پروژه‌های برنامه‌نویسی را در یک محیط یکپارچه فراهم می‌کند؛ مناسب برای تازه‌کارها تا توسعه‌دهنده‌های حرفه‌ای." },
      ...
      { q: "آیا استفاده از مورنا کد رایگان است؟", a: "نسخه‌ی پایه کاملاً رایگان است و شامل دسترسی به دوره‌های عمومی و مخازن نامحدود می‌شود؛ امکانات پیشرفته‌تر در پلن‌های اشتراکی ارائه می‌شوند." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "آیا کد خصوصی من توسط تیم  مورناکد دیده می‌شود؟", a: "خیر، مخازن خصوصی فقط برای خود شما و اعضای دعوت‌شده قابل مشاهده است، مگر با درخواست صریح شما برای پشتیبانی فنی." },
